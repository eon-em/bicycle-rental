...
INSERT INTO Locadora (id, nome, descricao, cnpj, cidade)
VALUES (@id_locadora, 'Gabi Bicicletas RJ', 'Viagens para toda a família carioca', '50.745.536/0001-03', 'Rio de Janeiro');

-- Make some locations (Bike)
INSERT INTO Bicicleta (clienteId, locadoraId, dataLocacao) VALUES
(2, 5, '2023-07-01'),
(3, 5, '2023-07-02'),
(4, 6, '2023-07-03');